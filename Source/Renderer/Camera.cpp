...
void Renderer::Camera::processKeyboard(Camera_Movement direction, float deltaTime)
{
...
void Renderer::Camera::processMouseMovement(float xoffset, float yoffset, GLboolean constrainPitch)
{
