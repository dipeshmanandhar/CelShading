...
Renderer::Shader::Shader(const char* vertexPath, const char* fragmentPath) : Shader()
{
...
// ------------------------------------------------------------------------
void Renderer::Shader::initialize(const char* vertexPath, const char* fragmentPath)
{
...
void Renderer::Shader::setVec2(const std::string& name, float x, float y) const
{
...
void Renderer::Shader::setVec3(const std::string& name, float x, float y, float z) const
{
...
void Renderer::Shader::setVec4(const std::string& name, float x, float y, float z, float w) const
{
...
// ------------------------------------------------------------------------
void Renderer::Shader::checkCompileErrors(GLuint shader, std::string type)
{
	GLint success;
	GLchar infoLog[1024];
	if (type != "PROGRAM")
