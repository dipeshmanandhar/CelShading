...
namespace Renderer
{
	...
	public:
		...
		/*  Functions  */
		glm::mat4 updateBone(const glm::mat4& parentsTransform);
	...
	private:
		...
		//const glm::mat4 boneToModelStatic;	// converts this bone space to model space in static pose (i.e., no animation)
